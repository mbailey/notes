...
![WSL agent architecture](../../../personal/projects/jupykey/YubiKey-Guide/media/schema_gpg.png)
...
Start from the [gen-params-rsa4096](../../../personal/projects/jupykey/YubiKey-Guide/contrib/gen-params-rsa4096) template. If you're using GnuPG v2.1.7 or newer, you can also use the ([gen-params-ed25519](../../../personal/projects/jupykey/YubiKey-Guide/contrib/gen-params-ed25519) template. These templates will not set the master key to expire - see [Note #3](#notes).
